...
if __name__ == "__main__":
    # UTR credentials - set via environment variables or config file
    email = os.getenv("UTR_EMAIL", "your-email@example.com")
    password = os.getenv("UTR_PASSWORD", "your-password")
